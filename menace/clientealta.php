...
<html>
 <head>
  ...
  <script>
      ...
      if((username == "") || (apellido == "") || (password == "") || (rol == 0)) {
  ...
  @import url('https://fonts.googleapis.com/css2?family=Roboto+Condensed:wght@300&display=swap');
	*{
    ...
    body{
      background: url(https://scontent.fgdl9-1.fna.fbcdn.net/v/t39.30808-6/307984619_102136999333644_8016684732814294018_n.jpg?_nc_cat=111&ccb=1-7&_nc_sid=e3f864&_nc_eui2=AeHZxzZ-Ul-d2K-UI2VwetkugrIssdxz27eCsiyx3HPbtx9-7jNjeAvEoO939MYDEc1SNZt3VRMRe-2DVcIZk3Yh&_nc_ohc=8PQMMLhLYh4AX8_qz6S&_nc_ht=scontent.fgdl9-1.fna&oh=00_AfApRBDZBsOaEbuij7bzW8oyXUuZlWW3cZvITy0JGTJZpw&oe=648519AD);
